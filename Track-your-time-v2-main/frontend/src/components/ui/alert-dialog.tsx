...
/**
 * Replaces native confirm(), which is suppressed or rendered as a jarring
 * system chrome dialog inside an installed PWA — particularly on iOS.
 */
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay ref={ref} className={cn('fixed inset-0 z-50 bg-black/70', className)} {...props} />
))
...
const AlertDialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('mt-5 flex gap-2', className)} {...props} />
)
